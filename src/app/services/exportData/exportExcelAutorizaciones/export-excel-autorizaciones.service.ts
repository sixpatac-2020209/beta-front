...
export class ExportExcelAutorizacionesService {
  ...
  downloadExcel(dataExcel : any):void {
    ...
    this._workbook.xlsx.writeBuffer()
      .then(data => {
          ...
          fs.saveAs(blob, 'Autorizaciones.xlsx')
        })
  }
  ...
  private _createTable(dataExcel : any) : void {
    ...
    titleCell.value = 'AUTORIZACIONES'
    ...
    headerRow.values = [
      '','#', 'Orden', 'Pedido', 'Cliente', 'Vendedor', 'Planta', 'Autorización'
    ]
