...
@Component({
  selector: 'app-autorizacion-produccion',
  templateUrl: './autorizacion-produccion.component.html',
  styleUrls: ['./autorizacion-produccion.component.css'],
...
export class AutorizacionProduccionComponent implements OnInit {
