...
@Component({
  selector: 'app-ordenes-fabricacion-produccion',
  templateUrl: './ordenes-fabricacion-produccion.component.html',
  styleUrls: ['./ordenes-fabricacion-produccion.component.css']
})
export class OrdenesFabricacionProduccionComponent implements OnInit {
