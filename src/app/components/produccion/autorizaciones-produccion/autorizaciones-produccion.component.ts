...
@Component({
  selector: 'app-autorizaciones-produccion',
  templateUrl: './autorizaciones-produccion.component.html',
  styleUrls: ['./autorizaciones-produccion.component.css']
})
export class AutorizacionesProduccionComponent implements OnInit {
