...
@Component({
  selector: 'app-orden-produccion-produccion',
  templateUrl: './orden-produccion-produccion.component.html',
  styleUrls: ['./orden-produccion-produccion.component.css']
})
export class OrdenProduccionProduccionComponent implements OnInit {
