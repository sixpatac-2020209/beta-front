...
@Component({
  selector: 'app-ordenes-fabricacion-disenio',
  templateUrl: './ordenes-fabricacion-disenio.component.html',
  styleUrls: ['./ordenes-fabricacion-disenio.component.css']
})
export class OrdenesFabricacionDisenioComponent implements OnInit {
