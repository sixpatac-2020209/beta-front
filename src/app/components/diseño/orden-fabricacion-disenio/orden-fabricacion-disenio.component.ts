...
@Component({
  selector: 'app-orden-fabricacion-disenio',
  templateUrl: './orden-fabricacion-disenio.component.html',
  styleUrls: ['./orden-fabricacion-disenio.component.css'],
...
export class OrdenFabricacionDisenioComponent implements OnInit {
