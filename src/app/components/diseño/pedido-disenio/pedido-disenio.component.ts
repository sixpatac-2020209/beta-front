...
@Component({
  selector: 'app-pedido-disenio',
  templateUrl: './pedido-disenio.component.html',
  styleUrls: ['./pedido-disenio.component.css']
})
export class PedidoDisenioComponent implements OnInit {
