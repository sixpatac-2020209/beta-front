...
@Component({
  selector: 'app-pedidos-disenio',
  templateUrl: './pedidos-disenio.component.html',
  styleUrls: ['./pedidos-disenio.component.css'],
...
export class PedidosDisenioComponent implements OnInit {
